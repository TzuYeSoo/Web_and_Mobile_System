...
<body>
   ...
   <div class="backdrop" id="backdrop"></div>
    ...
    <div class="add-stock-container" id="add_supplier">
        <div class="header_bg">
            <h2>SUPPLIER</h2>
            <button class="close-btn" onclick="closeSupplier()">&#10005;</button>
        </div>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="table-changers">
                <button class = "value" id="currentSupplier" onclick="currentSupplier()"> Current </button>
                <button class = "value" id="historySupplier" onclick="historySupplier()"> Archive </button>
            </div>
<!-- current supplier -->
