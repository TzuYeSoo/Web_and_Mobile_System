<?php 
    ...
    $history = "SELECT machine_id, machine_name, machine_type, machine_quantity, machine_room_no, machine_status, machine_unique_id 
    FROM machine WHERE machine_status = 0";

    $resutlArch = mysqli_query($conn, $history);
...
<div class = "stockin_container" id="modal_stockin">
    ...
    <div class="add-stock-container" id="add_machine">
        <div class="header_bg">
            <h2>MACHINE</h2>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="filter-dropdowns">
                <button class = "value" onclick="active()">Active</button>
                <button class = "value" onclick="archive()">Archive</button>
            </div>
<!-- Active table -->
            <div class="inventory-table" id="activemachine">
                <table>
                    <thead>
                        <tr>
                            <th> </th>
                                ...
                                ?> 
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="query_update_machine_status.php?id=<?= $row['machine_id'] ?>&action=1" class="action-icon" title="1" onclick="return confirm('Are you sure you want to archive this machine?');">
...
<!-- Active table -->
            <div class="inventory-table" id="historymachine">
                <table>
                    <thead>
                        <tr>
                            <th> </th>
                    ...
                    <tbody>
                        <?php 
                            ...
                            while($row=mysqli_fetch_assoc($resutlArch)){
            ...
            <button class="add-item-button" onclick="addMachine()">
